...
pub trait LicenseTypeResourceApi: Send + Sync {
    async fn get_license_intention<'id>(
        &self,
        id: i32,
    ) -> Result<ResponseContent<GetLicenseIntentionSuccess>, Error<GetLicenseIntentionError>>;
    async fn get_license_intentions(
        &self,
    ) -> Result<ResponseContent<GetLicenseIntentionsSuccess>, Error<GetLicenseIntentionsError>>;
}
...
impl LicenseTypeResourceApi for LicenseTypeResourceApiClient {
    async fn get_license_intention<'id>(
        ...
        let local_var_uri_str = format!(
            "{}/api/v1/license-types/intentions/{id}",
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            let local_var_entity: Option<GetLicenseIntentionSuccess> =
            ...
            let local_var_entity: Option<GetLicenseIntentionError> =
                serde_json::from_str(&local_var_content).ok();
    ...
    ) -> Result<ResponseContent<GetLicenseIntentionsSuccess>, Error<GetLicenseIntentionsError>>
    {
        ...
        let local_var_uri_str = format!(
            "{}/api/v1/license-types/intentions",
            local_var_configuration.base_path
        );
        let mut local_var_req_builder =
            local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            let local_var_entity: Option<GetLicenseIntentionsSuccess> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_result = ResponseContent {
                status: local_var_status,
                content: local_var_content,
            ...
            let local_var_entity: Option<GetLicenseIntentionsError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
